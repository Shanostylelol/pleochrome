    ...
    sheets: {
      assumptions: {
        ...
        cellData: {
          ...
          8: { 0: { v: "Token Price" }, 1: { v: 100000, s: "inp_curr" }, 2: { v: "$" }, 3: { v: "Min investment per token. Applicable to Tokenization path only." } },
      ...
      deal: {
        ...
        cellData: {
          ...
          24: {},
          25: { 0: { v: "PHASE 3: VALUE PATH EXECUTION", s: sectionStyle }, 1: { s: sectionStyle }, 2: { s: sectionStyle }, 3: { s: sectionStyle }, 4: { s: sectionStyle }, 5: { s: sectionStyle } },
          26: { 0: { v: "Tokenization Platform" }, 1: { v: 5500, s: currStyle }, 2: { s: inputStyle }, 3: { f: '=IF(C27="",B27,C27)', s: "calc_curr" }, 4: { v: "PleoChrome" }, 5: { v: "$5K\u201360K/yr \u2014 Rialto ($50K+$5K/mo) | Brickken (EUR 5K/yr) | Zoniqx (TBD)" } },
          27: { 0: { v: "Platform/structure configuration review" }, 1: { v: 3500, s: currStyle }, 2: { s: inputStyle }, 3: { f: '=IF(C28="",B28,C28)', s: "calc_curr" }, 4: { v: "PleoChrome" }, 5: { v: "Day 63-75" } },
          28: { 0: { v: "Integration & testing" }, 1: { v: 5000, s: currStyle }, 2: { s: inputStyle }, 3: { f: '=IF(C29="",B29,C29)', s: "calc_curr" }, 4: { v: "PleoChrome" }, 5: { v: "Day 65-80" } },
          ...
          31: { 0: { v: "Note: Costs shown for Tokenization path. See Deal Model for Fractional/Debt scenarios.", s: calcStyle } },
      ...
      pnl: {
        ...
        cellData: {
          0: { 0: { v: "P&L (Tokenization Path)", s: headerStyle }, 1: { v: "Year 1", s: headerStyle }, 2: { v: "Year 2", s: headerStyle }, 3: { v: "Year 3", s: headerStyle }, 4: { v: "Year 4", s: headerStyle }, 5: { v: "Year 5", s: headerStyle }, 6: { v: "5-Year Total", s: headerStyle } },
          ...
          24: {},
          25: { 0: { v: "Note: This P&L models the Tokenization path. See Deal Model page for multi-path comparison (Fractional, Tokenization, Debt).", s: calcStyle } },
        },
      },
      sources: {
        id: "sources",
        ...
        cellData: {
          ...
          6: { 0: { v: "Tokenization Platform" }, 1: { v: "$5,000\u201360,000/yr" }, 2: { v: "Annual" }, 3: { v: "Mar 2026" }, 4: { v: "Brickken EUR 5K/yr, Zoniqx TBD, Rialto full-stack $110K/yr" } },
          7: { 0: { v: "Rialto Markets" }, 1: { v: "$50K setup + $5K/mo + % fees" }, 2: { v: "Setup + Monthly + Success" }, 3: { v: "Mar 2026" }, 4: { v: "rialtomarkets.com" } },
          8: { 0: { v: "Chainlink BUILD" }, 1: { v: "$0 cash" }, 2: { v: "Token commit" }, 3: { v: "Mar 2026" }, 4: { v: "chain.link/build-program" } },
          9: { 0: { v: "Config Review" }, 1: { v: "$2.5K-$5K" }, 2: { v: "Per review" }, 3: { v: "Mar 2026" }, 4: { v: "softstack.io" } },
          10: { 0: { v: "Attorney (boutique)" }, 1: { v: "$7.5K-$12K" }, 2: { v: "Flat fee" }, 3: { v: "Mar 2026" }, 4: { v: "contractscounsel.com" } },
          11: { 0: { v: "Wyoming LLC" }, 1: { v: "$100" }, 2: { v: "One-time" }, 3: { v: "Mar 2026" }, 4: { v: "sos.wyo.gov" } },
          12: { 0: { v: "Form D (SEC)" }, 1: { v: "$0" }, 2: { v: "No fee" }, 3: { v: "Mar 2026" }, 4: { v: "sec.gov" } },
          13: { 0: { v: "Blue Sky (avg)" }, 1: { v: "$100-$500" }, 2: { v: "Per state" }, 3: { v: "Mar 2026" }, 4: { v: "blueskycomply.com" } },
          14: { 0: { v: "KYC (Veriff)" }, 1: { v: "$0.80/check" }, 2: { v: "Per check" }, 3: { v: "Mar 2026" }, 4: { v: "veriff.com" } },
          15: { 0: { v: "BD Placement" }, 1: { v: "5-7%" }, 2: { v: "Of raised" }, 3: { v: "Mar 2026" }, 4: { v: "FINRA" } },
          16: { 0: { v: "AML Audit" }, 1: { v: "$3K-$5K" }, 2: { v: "Annual" }, 3: { v: "Mar 2026" }, 4: { v: "BSA/AML" } },
          17: { 0: { v: "Note: Evaluating Brickken, Zoniqx, and Rialto \u2014 see DECISION-AUDIT-LOG.md", s: calcStyle } },
        },
      },
      timeline: {
        id: "timeline",
        ...
        cellData: {
          ...
          8: { 0: { v: "Platform setup (Rialto: 2-3 months | Brickken: 3-4 weeks | Zoniqx: 3-4 days sandbox)" }, 1: { v: 63 }, 2: { v: 63 }, 3: { v: 5500, s: currStyle }, 4: { v: 0, s: currStyle }, 5: { f: "=F8+E9-D9", s: currStyle }, 6: { v: "Tokenization" } },
