...
/* ═══════════════════════════════════════════════════════
   PleoChrome — Masterclass: How Gemstone Tokenization Works
   /learn
   ═══════════════════════════════════════════════════════ */
...
const sections: Section[] = [
  {
    id: "what", title: "What Is Gemstone Tokenization?", subtitle: "The Big Picture", icon: "gem", color: "#1A8B7A",
    intro: "Before we get into the details, let\u2019s understand the fundamental concept. Tokenization isn\u2019t complicated \u2014 it\u2019s just a new way to let multiple people invest in something that used to be all-or-nothing.",
    content: [
      ...
      { heading: "The Solution: Tokenization", body: "Now imagine you could split that $55 million ruby into 550 digital certificates (tokens), each worth $100,000. Suddenly, instead of needing ONE buyer with $55M, you need 550 investors who each have $100K. That\u2019s a much bigger pool of potential buyers. Each token represents real, legal ownership of a piece of the stone. The physical ruby stays safely locked in a vault. The tokens trade digitally. This is tokenization: turning one big, illiquid asset into many small, tradeable digital pieces." },
      ...
      { heading: "Who Is This For?", body: "Two groups: (1) Stone owners who want to unlock the value of their assets without selling outright \u2014 they keep a portion and sell the rest to investors. (2) Accredited investors (people with $200K+ income or $1M+ net worth) who want exposure to an asset class that historically appreciates 12-15% annually, retains 95% of value in downturns, and is completely uncorrelated with stocks and bonds." },
    ]
  },
  {
    id: "pleochrome", title: "What Does PleoChrome Actually Do?", subtitle: "Our Role in Plain English", icon: "layers", color: "#1B6B4A",
    intro: "PleoChrome is not a bank, not an exchange, not a vault, and not a crypto company. We\u2019re the orchestra conductor. We coordinate all the specialists who each handle one piece of the process.",
    content: [
      { heading: "The Orchestration Model", body: "Think of building a house. You don\u2019t need the general contractor to be the electrician, the plumber, AND the roofer. You need them to hire the right specialists, manage the schedule, inspect the work, and make sure everything comes together correctly. PleoChrome is the general contractor of gemstone tokenization. We coordinate: lab certification (GIA), independent appraisal, vault custody (Brink\u2019s), blockchain verification (Chainlink), token creation (Brickken), legal structuring (securities attorneys), and investor distribution (broker-dealers)." },
  ...
  },
  {
    ...
    content: [
      ...
      { heading: "Step 8: Digital Tokens Are Created on the Blockchain", body: "Using Brickken\u2019s tokenization platform, PleoChrome deploys an ERC-3643 security token on the Polygon blockchain. What does all that mean? ERC-3643 is a specific type of digital token designed for regulated securities. Unlike regular crypto tokens that anyone can send to anyone, ERC-3643 tokens have built-in rules: only investors who have been verified (KYC\u2019d and accredited) can hold them. If someone who isn\u2019t verified tries to receive a token, the transfer automatically fails at the code level. No human intervention needed.\n\nPolygon is the specific blockchain (digital ledger) where the tokens live. We chose it because transactions cost less than a penny (vs. $5-$50 on Ethereum), it processes in 2 seconds, and it\u2019s compatible with all institutional tools.\n\nBrickken is the platform that handles the actual deployment \u2014 like using Shopify to build an online store instead of coding from scratch. Their smart contracts are pre-audited, meaning security experts have already checked the code for vulnerabilities.\n\nAnalogy: Like printing stock certificates, except they\u2019re digital, they have built-in rules about who can own them, and they\u2019re recorded on a public ledger that can never be altered." },
  ...
  },
  {
    ...
    content: [
      ...
      { heading: "ERC-3643: The Compliance Token Standard", body: "Regular crypto tokens (like Bitcoin) can be sent to anyone, anytime, with no rules. That doesn\u2019t work for securities \u2014 securities have legal requirements about who can own them and how they can be traded.\n\nERC-3643 is a specific token standard designed for regulated securities. It bakes compliance rules directly into the token itself. Over $32 billion in assets have been tokenized using this standard, and the DTCC (the company that processes virtually all US stock trades) joined the ERC-3643 ecosystem in 2025.\n\nThe key innovation: identity is decoupled from the wallet. This means if an investor loses access to their wallet, their identity verification still exists separately and can be reconnected to a new wallet. It\u2019s more resilient than older approaches." },
      ...
      { heading: "Brickken: The Tokenization Engine", body: "PleoChrome doesn\u2019t build blockchain software from scratch. That would be like building your own car engine instead of buying a Toyota. Brickken is a Barcelona-based company that provides a ready-made tokenization platform.\n\nWhat Brickken provides:\n\u2022 Pre-built, pre-audited smart contracts (security experts have already checked the code)\n\u2022 A dashboard for deploying and managing tokens\n\u2022 Built-in KYC verification (150 checks included per year)\n\u2022 Investor management tools\n\u2022 Compliance guidance\n\nPleoChrome uses Brickken\u2019s Advanced tier at approximately $5,500/year. This is dramatically cheaper than building custom blockchain infrastructure, which could cost $100K-$500K+" },
    ]
  },
  {
          ...
          <>
            <div className={`${cd} border rounded-2xl p-4 sm:p-5 mb-5`}>
              <p className={`text-xs sm:text-sm ${s2} leading-relaxed`}>
                ...
                Each chapter explains a different aspect of gemstone tokenization in plain language, with real-world
                analogies and visual examples. Start from the top or jump to any topic.
              </p>
            </div>
